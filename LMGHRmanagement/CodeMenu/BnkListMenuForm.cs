...
namespace LMGHRmanagement
{
    public partial class BnkListMenuForm : Form
    {
        ...
        public void Bnk_Load()
        {
            ...
            con.Open();
            OracleDataAdapter adapt = new OracleDataAdapter("Select CD_CODE, CD_CODNM From LMG_TINSA_CD Where CD_CODNM Like '%" + textBox1.Text + "%' And CD_GRPCD = 'BNK' AND CD_USE = 'Y' Order By CD_CODE", con);
