...
namespace LMGHRmanagement
{
    public partial class MilRankListForm : Form
    {
        ...
        public void Mil_Load()
        {
            ...
            con.Open();
            OracleDataAdapter adapt = new OracleDataAdapter("Select CD_CODE, CD_CODNM From LMG_TINSA_CD Where CD_GRPCD = 'CLS'" +
